...
pdf("dbRDA_best_fit_KO.pdf", width = 10, height = 8)
ggplot() +
geom_point(data = plot.df, aes(CAP1, CAP2, shape = plot, color = harmonic), size = 3) +
geom_segment(data = plot.df.biplot, aes(x = 0, y = 0, xend = CAP1/3.15, yend = CAP2/3.15), color = "black", arrow = arrow(length = unit(0.015, "npc"))) +
#scale_color_gradient(low = "#0571b0", high = "#ca0020") +
geom_text(data = plot.df.biplot, aes(CAP1/3, CAP2/3, label = label), size = 5) +
