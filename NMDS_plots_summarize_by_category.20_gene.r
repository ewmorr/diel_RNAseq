...
saveRDS(reads_per_len.nmds, file = "intermediate_RDS/20_gene_nmds_full.rds")
...
saveRDS(reads_per_len.wide.P1.nmds, file = "intermediate_RDS/20_gene_nmds.P1.rds")
saveRDS(reads_per_len.wide.P2.nmds, file = "intermediate_RDS/20_gene_nmds.P2.rds")
saveRDS(reads_per_len.wide.P3.nmds, file = "intermediate_RDS/20_gene_nmds.P3.rds")
