...
saveRDS(reads_per_len.sumCat.relAbd, "GH_relative_abd.metaG.rds")
write.table(reads_per_len.sumCat.relAbd, file = "GH_rel_abd.metaG.txt", sep = "\t", row.names = F, quote = F)
...
pdf("GH_rel_abd_top_ten.metaG.pdf", width = 14, height = 6)
print(p1)
dev.off()
...
pdf("GH_rel_abd_top_ten_scatterPlots.metaG.pdf", width = 16, height = 20)
print(p1)
print(p2)
dev.off()

pdf("GH_rel_abd_top_ten_TOD_scatterPlots.metaG.pdf", width = 28, height = 10)
#print(p1)
print(p2)
dev.off()
